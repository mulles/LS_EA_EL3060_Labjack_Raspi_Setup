...
for x in range(0, 30):
    ...
    print("Voltage",int(query_data[3:len(query_data)-6].hex(),16)*160.0/25600,"V \n")
    ...
    print("Current: ",int(query_data[5:len(query_data)-4].hex(),16)*60.0/25600,"A \n")

    # print("Power in hex",query_data[7:len(query_data)-2].hex())
    # print("Power scaled in int ",int(query_data[7:len(query_data)-2].hex(),16))
    print("Power",int(query_data[7:len(query_data)-2].hex(),16)*400.0/25600,"W \n")
    ...
    print("CoulombCounter ",struct.unpack('>f', query_data[3:7]),"Ah \n")
